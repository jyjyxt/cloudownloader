...
| Command | Description |
|---------|-------------|
| `cloudl autohome brand <品牌>` | A brand's car series + 厂商指导价 (guide price) |
| `cloudl autohome score <series_id>` | 口碑 rating: overall + per-dimension + 故障率PPH + competitors |
...
cloudl autohome brand 宝马
cloudl autohome brand 比亚迪 --limit 80
cloudl autohome brand 理想

# Owner-rating summary for a series
cloudl autohome score 6548        # 宝马X5

# JSON output
cloudl autohome brand 丰田 -f json
```

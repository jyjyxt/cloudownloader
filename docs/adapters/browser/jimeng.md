...
| Command | Description |
|---------|-------------|
| `cloudl jimeng generate` | 即梦AI 文生图 — 输入 prompt 生成图片 |
| `cloudl jimeng history` | 查看生成历史 |

## Usage Examples

```bash
# Generate an image
cloudl jimeng generate --prompt "一只在星空下的猫"

# Use a specific model
cloudl jimeng generate --prompt "cyberpunk city" --model high_aes_general_v50

# Set custom wait timeout
cloudl jimeng generate --prompt "sunset landscape" --wait 60

# View generation history
cloudl jimeng history --limit 10
```

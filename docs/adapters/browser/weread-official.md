...
| Command | Description |
|---------|-------------|
| `cloudl weread-official search <keyword>` | Search the WeRead store via `/store/search` (9 scope codes) |
| `cloudl weread-official shelf` | Sync your shelf — books, albums, and the `文章收藏` (article) entry |
| `cloudl weread-official book <bookId>` | Book metadata + chapter list + reading progress (3-in-1) |
| `cloudl weread-official notes [bookId]` | Notebook overview, or merged highlights + thoughts for a specific book |
| `cloudl weread-official review <bookId>` | Browse public reviews of a book |
| `cloudl weread-official readdata` | Reading statistics: time, streak, preferences, top books |
| `cloudl weread-official discover [bookId]` | Personalized recommendations (no bookId) or similar books (with bookId) |
| `cloudl weread-official list-apis` | List every `api_name` supported by the gateway (meta endpoint) |

## Usage Examples

```bash
# Search
cloudl weread-official search "三体"
cloudl weread-official search "刘慈欣" --scope author --count 20
cloudl weread-official search "AI" --scope ebook --max-idx 20   # next page

# Shelf — books + albums + article-bookmark entry
cloudl weread-official shelf

# Book detail (info + chapters + progress)
cloudl weread-official book 3300045871
cloudl weread-official book 3300045871 --no-chapters   # skip chapter list
cloudl weread-official book 3300045871 --no-progress   # skip reading progress

# Notebook overview (all books you've annotated)
cloudl weread-official notes
cloudl weread-official notes --last-sort 1748563200    # next page cursor

# Merged highlights + thoughts for a specific book
cloudl weread-official notes 3300045871

# Public reviews of a book
cloudl weread-official review 3300045871
cloudl weread-official review 3300045871 --type recommend --count 20
cloudl weread-official review 3300045871 --type newest

# Reading statistics
cloudl weread-official readdata --mode weekly
cloudl weread-official readdata --mode monthly
cloudl weread-official readdata --mode annually
cloudl weread-official readdata --mode overall
cloudl weread-official readdata --mode weekly --base-time 1748563200

# Discover — personalized recommendations
cloudl weread-official discover --count 20

# Discover — books similar to a given one
cloudl weread-official discover 3300045871 --count 20

# Meta — list every gateway endpoint
cloudl weread-official list-apis

# JSON output (useful for piping into other tools)
cloudl weread-official book 3300045871 -f json
```

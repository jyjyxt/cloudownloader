/**
 * Plugin manifest: reads and validates cloudl-plugin.json files.
 *
 * Supports two modes:
...
export const MANIFEST_FILENAME = 'cloudl-plugin.json';

// ── Read / Validate ─────────────────────────────────────────────────────────

/**
 * Read and parse cloudl-plugin.json from a directory.

...
describe('xiaoyuzhou auth helpers', () => {
    ...
    it('refreshes credentials and persists the updated token file', async () => {
        ...
        expect(mockMkdirSync).toHaveBeenCalledWith('/Users/tester/.cloudl', { recursive: true });
        expect(mockWriteFileSync).toHaveBeenCalledWith('/Users/tester/.cloudl/xiaoyuzhou.json', expect.stringContaining('"access_token": "new-access"'), 'utf-8');
    });
